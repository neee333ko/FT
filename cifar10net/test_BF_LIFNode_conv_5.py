...
class Cifar10NetTester(train_classify.Trainer_step):
    ...
    def get_tb_logdir_name(self, args):
        tb_dir = 'test/'+ f'{args.model}' + '_test_BF_' + 'conv_5_' + f'{args.rate}' + '_LIFNode'
        return tb_dir
    ...
    def evaluate(self, args, model, criterion, data_loader, tb_writer, device, num_classes, log_suffix=""):
        ...
        while rate <= args.rate:
            ...
            while round < 5:
                ...
                # only inject conv_2
                fixed_state_dict, maps = inject.inject_weight(convs[1:2], state_dict, rate/1000, None)
                ...
                # only inject conv_2
                fixed_state_dict, maps = inject.inject_weight(convs[1:2], state_dict, rate/1000, maps)
