...
class Cifar10NetTester(train_classify.Trainer_step):
    ...
    def get_tb_logdir_name(self, args):
        tb_dir = 'test/'+ f'{args.model}' + '_test_BF_' + 'conv_2_' + f'{args.rate}' + '_ParametricLIFNode'
        return tb_dir
